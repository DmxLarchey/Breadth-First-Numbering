...
Section bfn_fifo.
  ...
  Definition bfn_fifo_f n p : { q | fifo_list p ~lt rev (fifo_list q) /\ is_bfn_from n (rev (fifo_list q)) }.
  Proof.
  ...
  Section bfn.
    ...
    Let bfn_fifo_full t : { t' | t ~t t' /\ is_seq_from 0 (bft_std t') }.
    Proof.
    ...
    Proof. apply is_seq_from_spec, (proj2_sig (bfn_fifo_full t)). Qed.
