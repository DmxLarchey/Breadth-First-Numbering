...
Section incl.
  ...
  Fact incl_pres_perm_left m1 m2 l: m1 ~p m2 -> incl m2 l -> incl m1 l.
  Proof.
    intros H1 H2 ? H. apply H2; revert H.
    apply Permutation_in; auto.
  Qed.


  Fact incl_pres_perm_right m l1 l2: l1 ~p l2 -> incl m l1 -> incl m l2.
  Proof.
...
Section pigeon.
  ...
  Proof.
    ...
    - apply Permutation_sym in H1.
      ...
      apply in_list_hd0; left; auto.
    - left.
      apply (incl_pres_perm_left H1 H3).
    - right; right.
      exists m2; auto.
  Qed.
      ...
      + simpl in H1; apply le_S_n in H1.
        ...
        * apply incl_right_cons_incl_or_lhd_or_perm in H4.
          ...
          -- apply Permutation_sym in H4.
             ...
             { apply (incl_pres_perm_right Hl' H5). }
             clear H5.
  ...
  Proof.
    ...
    { destruct (@length_le_and_incl_implies_dup_or_perm l m) as [ H5 | H5 ].
      - omega.
      - assumption.
      - assumption.
      - contradict H1.
        intro H.
        apply Permutation_length in H5.
        rewrite H5 in H.
        omega.
    }
    (* previous proof:
